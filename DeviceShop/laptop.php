<html>
    ...
    <head><title> Demo Electronics - Laptop </title></head>
    <body>
    <li style = "padding-right:50; float: right; list-style:none;">  <a style="padding-right:50;"> <i  class="fas fa-phone"></i> Phone: 5644354 </a> 
        ...
        <nav class="nav-bar">
         ...
         <img srt="image/Sponsor.jpg">
            ...
            $q = "select  brand, model, cost, ram, processor, imageul, storage, display from productslist where type='Laptop';";
            ...
            while($row = mysqli_fetch_assoc($qry)) {
                ...
                echo "<td><form acticon='product.php' method='post'><li style=\"width: 200;
                text-align: center;
                list-style: none;
                color: white;
                ...
                padding: 10;
                text-decoration: none;
                margin-bottom: 20;\"   value = \"Order\"> Order </a></li></form></td>";
                echo "</tr>";
              }
              echo "</table>";
            ?>
